...
- [x] **Step 1: `backend/app/schemas/user.py` 작성**
...
- [x] **Step 2: `backend/app/schemas/room.py` 작성**
...
- [x] **Step 3: `backend/app/schemas/message.py` 작성**
...
- [x] **Step 4: `backend/app/api/routes/users.py` 작성**
...
- [x] **Step 5: `backend/app/api/routes/rooms.py` 작성**
...
- [x] **Step 6: `backend/app/api/routes/messages.py` 작성**
...
- [x] **Step 7: `backend/app/db/models.py` 에 relationship 추가**
...
- [x] **Step 8: `backend/app/main.py` 에 라우터 등록**
...
- [x] **Step 9: `backend/tests/test_rooms.py` 작성**
...
- [x] **Step 1: `frontend/package.json` 작성**
...
- [x] **Step 2: `frontend/tsconfig.json` 작성**
...
- [x] **Step 3: `frontend/vite.config.ts` 작성**
...
- [x] **Step 4: `frontend/index.html` 작성**
...
- [x] **Step 5: `frontend/src/types/index.ts` 작성**
...
- [x] **Step 6: `frontend/src/api/client.ts` 작성**
...
- [x] **Step 7: `frontend/src/store/auth.ts` 작성**
...
- [x] **Step 8: `frontend/src/store/chat.ts` 작성**
...
- [x] **Step 9: `frontend/src/main.tsx` 작성**
...
- [x] **Step 10: `frontend/src/App.tsx` 작성 (뼈대만)**
...
- [x] **Step 11: `frontend/src/index.css` 생성 (CSS 리셋)**
...
- [x] **Step 1: `frontend/src/components/Auth/LoginForm.tsx` 작성**
...
- [x] **Step 2: `frontend/src/components/Auth/RegisterForm.tsx` 작성**
...
- [x] **Step 3: `frontend/src/App.tsx` 업데이트**
...
- [x] **Step 1: `frontend/src/hooks/useWebSocket.ts` 작성**
...
- [x] **Step 2: `frontend/src/App.tsx` 에 훅 연결**
...
- [x] **Step 1: `frontend/src/components/Sidebar/Sidebar.tsx` 작성**
...
- [x] **Step 2: `frontend/src/App.tsx` 에 사이드바 포함**
...
- [x] **Step 1: `frontend/src/components/Chat/MessageBubble.tsx` 작성**
...
- [x] **Step 2: `frontend/src/components/Chat/TypingIndicator.tsx` 작성**
...
- [x] **Step 3: `frontend/src/components/Chat/MessageInput.tsx` 작성**
...
- [x] **Step 4: `frontend/src/components/Chat/ChatWindow.tsx` 작성**
...
- [x] **Step 5: `frontend/src/App.tsx` 최종 업데이트**
...
- [x] **Step 6: `backend/app/api/routes/auth.py` 에 `/auth/me` 추가**
...
- [x] **Step 7: `frontend/src/App.tsx` 에서 `/auth/me` 로 유저 정보 로드**
...
- [x] **Step 8: 브라우저에서 수동 테스트 (브라우저 2개 필요)**
...
- [x] 회원가입 → 로그인 → JWT 토큰 발급
- [x] 채팅방 생성 및 멤버 초대
- [x] DM 방 생성 (중복 없음)
- [x] 실시간 메시지 전송 (두 브라우저 탭에서 테스트)
- [x] 타이핑 인디케이터 표시
- [x] 온라인/오프라인 상태 표시
- [x] 읽음 확인 (`last_read_at` 업데이트)

...
export default function Sidebar({ onSelectRoom, activeRoomId, isMobile }: Props) {
  ...
  return (
    <div style={isMobile ? { ...styles.container, width: '100%', borderRight: 'none' } : styles.container}>
